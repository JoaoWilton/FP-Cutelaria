...
/**
 * DTO de entrada para POST/PUT em /administrativo/v1/guarnicoes.
 * Não expõe o campo "id" — gerado pelo banco (mesmo padrão de MaterialDTO).
 */
public class CriarGuarnicaoDTO {
    ...
    public String tipoPeca; // "Guarda", "Botão", "Espaçador"

    public Boolean polimentoRealizado;
}
